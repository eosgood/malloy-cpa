            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:2094251999" className="text-blue-600 hover:text-blue-800 transition-colors">
                    (209) 425-1999
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:jack@malloycpa.com" className="text-blue-600 hover:text-blue-800 transition-colors">
                    jack@malloycpa.com
                  </a>
                </div>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <div className="text-center">
                ...
                <div className="space-y-2">
                  <a 
                    href="tel:2094251999"
                    className="block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200"
                  >
                    Call (209) 425-1999
                  </a>
                  <a 
                    href="mailto:jack@malloycpa.com"
                    className="block border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200"
                  >
