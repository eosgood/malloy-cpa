        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We combine professional expertise with personalized service to deliver exceptional results for our clients throughout the Central Valley.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Direct access to your CPA with personalized attention and customized solutions for your unique financial situation.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Over a decade of public accounting experience with deep expertise in tax preparation, planning, and business consulting.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Deep understanding of Central Valley business environment, local regulations, and tax considerations specific to our region.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Let&rsquo;s discuss your tax and accounting needs. Contact us today for a consultation and discover how our personalized approach can benefit you.
          </p>
