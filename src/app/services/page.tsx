  ...
  const services = [
    {
      ...
      description: "Accurate and timely preparation of individual and business tax returns with expertise in navigating complex tax codes.",
      features: [
    ...
    },
    {
      ...
      description: "Strategic tax planning to minimize liabilities and optimize financial outcomes for individuals and businesses.",
      features: [
    ...
    },
    {
      ...
      description: "Specialized services for small businesses including sole proprietors, partnerships, and LLCs.",
      features: [
